...
const ProductsPage = () => {
  ...
  // حساب كمية المنتج في مخزن معين (يدعم الحركات المتعددة)
  const getWarehouseQty = (productId: string, warehouseId: string) => {
    ...
    movements.forEach(m => {
      ...
      if (m.product_id === productId) {
        ...
        // حركة متعددة - ابحث عن المنتج داخل items
  ...
  // حساب إجمالي كمية المنتج من جميع الحركات (يدعم الحركات المتعددة)
  ...
  // الحصول على أسماء المخازن التي تحتوي على حركات لهذا المنتج (يدعم الحركات المتعددة)
  ...
  // الكمية المعروضة حسب المخزن المحدد أو الإجمالي
